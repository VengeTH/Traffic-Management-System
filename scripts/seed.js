  ...
  try {
    ...
    const violations = await Violation.bulkCreate([
      ...
      },
      {
        ...
        violationDescription: 'Parked in a no-parking zone for more than 1 hour',
