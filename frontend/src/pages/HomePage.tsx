            ...
            >
              <div className="flex items-start gap-4 sm:gap-5">
                ...
                <div className="flex-1 min-w-0">
                  <h3 className="text-xl sm:text-lg font-bold text-gray-900 leading-tight whitespace-nowrap">
                    {item.title}
                  </h3>
                  <p className="mt-2 sm:mt-2.5 text-base sm:text-base text-gray-700 leading-relaxed break-normal">
                    {item.description}
                  </p>
                </div>
              </div>
