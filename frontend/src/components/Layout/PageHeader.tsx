...
const PageHeader: React.FC<PageHeaderProps> = ({
  ...
  return (
    <header
      className={`relative overflow-hidden rounded-[28px] border border-primary-100 bg-gradient-to-r from-white via-green-50 to-white px-8 py-7 shadow-xl ${className}`}
    >
